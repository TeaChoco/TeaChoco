...
const blogPosts = [
    {
        ...
        defaultExcerpt:
            'Learn how to set up SSR for React Application for better SEO.',
    ...
    },
    {
        ...
        defaultExcerpt:
            'Benefits of using TypeScript and reasons to switch from JavaScript.',
        ...
        <Section>
            <div className="page-header">
                ...
                <p className="page-subtitle">
                    {t(
                        'blog.subtitle',
                        'Sharing knowledge and experience in software development',
                    )}
                </p>
            </div>
