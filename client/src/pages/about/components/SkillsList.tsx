                ...
                >
                    <div className='flex justify-between items-center mb-3'>
                        <div className='flex items-center gap-3'>
                            <div
                                ...
                                style={{
                                    backgroundColor: `${skill.color ?? hex}20`,
                                    boxShadow: `0 0 0 1px ${skill.color ?? hex}35`,
                                }}
                            >
                                <skill.icon
                                    className='text-lg'
                        ...
                        <span className='text-sm font-bold' style={{ color: skill.color ?? hex }}>
                            {skill.level}%
                        </span>
                    </div>
                    <div className='h-2 bg-border-light dark:bg-border-dark rounded-full overflow-hidden'>
                        <motion.div
                            ...
                            style={{
                                background: `linear-gradient(90deg, var(--color-primary), ${skill.color ?? hex})`,
                            }}
                        />
                    </div>
                </motion.div>
